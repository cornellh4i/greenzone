...
const Slide: React.FC<SlideProps> = ({ name, selectedValue, onChange, min, max }) => {
  ...
  return (
    <Box display="flex" flexDirection="column" alignItems="flex-start" mb={2}>
      <Box display="flex" width="100%" justifyContent="space-between" alignItems="center">
        <span style={{ fontFamily: "Poppins", fontSize: "20px", fontWeight: "600", lineHeight: "28.6px",
           letterSpacing: "0.17px", textAlign: "left", textDecoration: "none" }}> {name}</span>
        <Box ml={2} p={1} bgcolor="grey.300" borderRadius="4px" display="inline-block" width="auto">
          <span style={{ fontFamily: "Poppins", fontSize: "20px", fontWeight: "600", lineHeight: "28.6px",
           letterSpacing: "0.17px", textAlign: "left", textDecoration: "none" }}>{value}</span>
        </Box>
      </Box>
      <Slider
        value={value}
